#[cfg(test)]
mod tests {
    use dcm_io::{DicomReader, PersonName};
    ...
    pub struct RequiredField {
        #[dicom(tag = "0010,0020", vr = "PN")]
        pub field: PersonName,
    }

    #[derive(Dicom, Default, Clone)]
    pub struct RequiredFields {
        #[dicom(tag = "(0012,0063)", vr = "PN")]
        pub field: Vec<PersonName>,
    }

    #[derive(Dicom, Default, Clone)]
    pub struct OptionalField {
        #[dicom(tag = "0010,0020", vr = "PN")]
        pub field: Option<PersonName>,
    }

    #[derive(Dicom, Default, Clone)]
    pub struct OptionalFields {
        #[dicom(tag = "(0012,0063)", vr = "PN")]
        pub field: Option<Vec<PersonName>>,
    }
    ...
    fn read_required_dicom_tags_field() {
        ...
        let ime = DataElement::new(
            Tag(0x0012, 0x0063),
            VR::PN,
            dicom_core::PrimitiveValue::Strs(vec!["Doe^John".into(), "Smith^Jane".into()].into()),
        );
        let _ = obj.put_element(ime);
        ...
        assert_eq!(
            ...
            PersonName::from_str("Smith^Jane").unwrap()
        );
    }
