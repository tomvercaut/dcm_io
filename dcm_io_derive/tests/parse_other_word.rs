...
mod tests {
    ...
    pub struct RequiredField {
        #[dicom(tag = "0010,0020", vr = "OW")]
        pub field: u16,
    }

    #[derive(Dicom, Default, Clone)]
    pub struct RequiredFields {
        #[dicom(tag = "(0012,0063)", vr = "OW")]
        pub field: Vec<u16>,
    }
    ...
    fn read_required_dicom_tag_field() {
        ...
        let ime = DataElement::new(
            Tag(0x0010, 0x0020),
            VR::OL,
            dicom_core::PrimitiveValue::U16(vec![42].into()),
        );
    ...
    fn read_required_dicom_tags_field() {
        ...
        let ime = DataElement::new(
            Tag(0x0012, 0x0063),
            VR::OW,
            dicom_core::PrimitiveValue::U16(vec![10, 20].into()),
        );
        let _ = obj.put_element(ime);
