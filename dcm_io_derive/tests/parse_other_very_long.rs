...
mod tests {
    ...
    pub struct RequiredField {
        #[dicom(tag = "0010,0020", vr = "OV")]
        pub field: u64,
    }

    #[derive(Dicom, Default, Clone)]
    pub struct RequiredFields {
        #[dicom(tag = "(0012,0063)", vr = "OV")]
        pub field: Vec<u64>,
    }
    ...
    fn read_required_dicom_tag_field() {
        ...
        let ime = DataElement::new(
            Tag(0x0010, 0x0020),
            VR::OV,
            dicom_core::PrimitiveValue::U64(vec![42].into()),
        );
    ...
    fn read_required_dicom_tags_field() {
        ...
        let ime = DataElement::new(
            Tag(0x0012, 0x0063),
            VR::OV,
            dicom_core::PrimitiveValue::U64(vec![10, 20].into()),
        );
        let _ = obj.put_element(ime);
